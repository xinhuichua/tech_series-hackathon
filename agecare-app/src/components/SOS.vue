...
export default {
  methods: {
    ...
    async sendTelegramMessage(message) {
      ...
      const chatId = '311341386'; // Replace with your chat ID use the link to find chat id: https://api.telegram.org/bot7129549276:AAEst0pSSbyIVm8ReCWTpwlck3Q5uCGExhI/getUpdates?offset=6845319, group chat id is: -1002147797812
